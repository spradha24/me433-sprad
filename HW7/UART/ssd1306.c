...
void ssd1306_setup() {
    ...
    //}
    sleep_ms(20);
    ssd1306_command(SSD1306_DISPLAYOFF); // turn off
    ssd1306_command(SSD1306_SETDISPLAYCLOCKDIV); // set the clock
    ssd1306_command(0x80); // to hex 80
    ssd1306_command(SSD1306_SETMULTIPLEX); // says its 32 not the taller one
